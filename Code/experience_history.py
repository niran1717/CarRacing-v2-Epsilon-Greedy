# experience_history.py
import numpy as np

class ExperienceHistory:
    """A class for storing the agent's experiences."""
    ...
    def init_caches(self):
        ...
        self.prev_states = -np.ones((self.capacity, self.num_frame_stack), dtype="int32")
        self.next_states = -np.ones((self.capacity, self.num_frame_stack), dtype="int32")
